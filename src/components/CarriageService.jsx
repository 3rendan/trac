  ...
  return (
    <div className='container'>
      ...
      <div className='faq-answers'>
        ...
        <p>APT carriage service is a separate fee-based service enabling producers to track their program's scheduled air dates on more than 340 public stations located across the country. The data is made available through our carriage website - developed in conjunction with TRAC-Media, our preferred supplier of carriage data for APT programs.</p>
        <h4 id='what_data'>What data is available on the carriage website?</h4>
        <p>This website offers direct access to carriage data in an easy-to-read format, 24 hours a day, seven days a week. It also provides a wealth of research options to help compile and analyze data for your programs. Those who use this service find it provides information which is incredibly valuable both to demonstrate market penetration to current sponsors and to assist in demonstrating success so important in securing future underwriting.</p>
        ...
        <p>Producers may purchase access through APT and must be affiliated with the program they wish to track. We do not share your title’s tracking information with other producers. We have negotiated special rates with TRAC-Media for our clients specifically.</p>

        <h4 id='multiple'>May I track more than one program?</h4>
        <p>Yes. Please note that cost is separate per title and is based on number of episodes. The titles you wish to track <span className='fw-bolder'>must be in current distribution by APT.</span></p>

        <h4 id='purchase'>May I purchase one simple report of past airings?</h4>
        <p>Yes. In addition, we also provide pricing for a one-time report of past airdates. Cost is based on date-range of data requested. Please contact us for a price quote.</p>

        <h4 id='contact'>Who do I contact to inquire about this service?</h4>
        <p>Please call or email <a href='mailto:olivia_wong@aptonline.org'>Olivia Wong</a> at 617-338-4455, x. 129.</p>
